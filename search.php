...
if ($wp_query->found_posts > 1 ) {
   echo $wp_query->found_posts." razy.</small>";
...
<?php if (have_posts()) : while (have_posts()) : the_post();?>
    <li class='menu-item' id="post-<?php the_ID(); ?>"><a itemprop='relatedLink' href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></li>
<?php endwhile; ?>
<?php wpex_pagination(); ?>
<?php else : ?>
