...
<ins class="adsbygoogle"
     ...
     data-ad-client="ca-pub-7780237578081579"
     data-ad-slot="8661905540"
...
if ($posttags) foreach($posttags as $tag) echo "<a rel='tag' href='".get_tag_link($tag->term_id)."'><h2 class='btn btn-primary btn-xs tagBtn'>".$tag->name."</h2></a>";
 ?>
</div>
<div class="col-lg-3 col-md-3 col-sm-12">
  <div class="art-info">    <?php the_time('j F Y'); ?><br>
  <?php the_author(); ?></div>
</div>
